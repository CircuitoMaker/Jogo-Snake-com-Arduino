//**************************************************************************************************************
// CRIADO POR http://fabianoallex.blogspot.com.br/2015/09/arduino-array-de-bits.html
// ALTERADO POR http://www.circuitomaker.com EM 14/11/2017
//**************************************************************************************************************/
...
if(analogRead(A1)>= 800){snake.bottom();   }
if(analogRead(A1)<= 200){snake.top();}   
if(analogRead(A2)>= 800){snake.left();  }
if(analogRead(A2)<= 200){snake.right(); }   
